	...
	var myGrid;
		$(function(){
			 myGrid=MGrid.initGrid({
				 url:"${path}/do/admin/sysBtn/showList",
				 delUrl:"${path}/do/admin/sysBtn/del"
			 });
		});
		...
		function openAdd() {
			layer.open({
				...
				content : [ '${path}/do/admin/sysBtn/editForm', 'no' ]
			}); 
		}
		//打开编辑界面
		function openEdit(id) {
			layer.open({
				...
				area : [ MUI.SIZE_S, '300px' ],
				maxmin : true,
				content : [ '${path}/do/admin/sysBtn/editForm?id=' + id,'no' ]
			});
		}
	</script>
</body>
