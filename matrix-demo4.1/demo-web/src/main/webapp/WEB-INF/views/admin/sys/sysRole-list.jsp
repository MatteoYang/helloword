...
<script type="text/javascript"
	...
	<script type="text/javascript">
		...
		$(function() {
			...
			var delUrl="";
			<matrix:btn value="role:dels"> 
			delUrl="${path}/do/admin/sysRole/su/del";
			</matrix:btn>
			
			myGrid = MGrid.initGrid({
				url : "${path}/do/admin/sysRole/su/showCompanyRole",
				delUrl:delUrl
			});
		});
		...
		layer.full(	layer.open({
				...
				maxmin : true,
				content : [ '${path}/do/admin/sysRole/su/editForm' ]
			}));
		}
		</matrix:btn>
		...
		function openEdit(id) {
			layer.full(	layer.open({
				...
				area : [ MUI.SIZE_L, '500px' ],
				maxmin : true,
				content : [ '${path}/do/admin/sysRole/su/editForm?id=' + id ]
			}));
		}
		</matrix:btn>
	</script>
