	...
	var myGrid;
		$(function(){
			 myGrid=MGrid.initGrid({
				 url:"${path}/do/admin/sysPlat/showList",
				 delUrl:"${path}/do/admin/sysPlat/del"
			 });
		});
		...
		function openAdd() {
			layer.open({
				...
				content : [ '${path}/do/admin/sysPlat/editForm', 'no' ]
			}); 
		}
		//打开编辑界面
		function openEdit(id) {
			layer.open({
				...
				area : [ MUI.SIZE_S, '300px' ],
				maxmin : true,
				content : [ '${path}/do/admin/sysPlat/editForm?id=' + id,'no' ]
			});
		}
	</script>
</body>
