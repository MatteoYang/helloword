	...
	<!-- 搜索框部分start -->
		<form class="form-inline" id="serchform">
			<div class="form-group mr-20">
				...
				<input name="comName" type="text" class="form-control">
			</div>
	...
	var myGrid;
		$(function(){
			 myGrid=MGrid.initGrid({
				 url:"${path}/do/admin/sysCompany/showList",
				 delUrl:"${path}/do/admin/sysCompany/del"
			 });
		});
		...
		function openAdd() {
			layer.open({
				...
				content : [ '${path}/do/admin/sysCompany/editForm']
			}); 
		}
		//打开编辑界面
		function openEdit(id) {
			layer.open({
				...
				area : [ MUI.SIZE_L, '500px' ],
				maxmin : true,
				content : [ '${path}/do/admin/sysCompany/editForm?id=' + id]
			});
		}
	</script>
</body>
