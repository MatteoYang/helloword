		...
		<div class="row">
			...
			<div class="col-sm-5">
				<form method="post" method="post" class="dataForm">
					...
					<matrix:debug>
						<a type="button" href="${path }/do/common/debugLogin"
...
<script type="text/javascript" src="${path }/resource/js/plugin/jsencrypt.min.js"></script>
<script type="text/javascript">
	...
	function login() {
		...
		}).invoke("${path}/do/common/dologin", function(loj) {
			MTools.redirect("${path}/do/" + loj.getValue("page"));
		});
	}
	function dologin(e) {
		if (e.keyCode == 13) {
