	...
	<div id="wrapper">
					...
					<li class="nav-header">
						<div class="dropdown profile-element">
							...
							<ul class="dropdown-menu animated fadeInRight m-t-xs">
								<li class="divider"></li>
								<li><a href="${path }/do/common/loginOut">安全退出</a></li>
							</ul>
						</div>
					...
					<li><a href="#"><i class="fa fa-table"></i> <span
						...
						<ul class="nav nav-second-level">
							<li><a class="J_menuItem"
								href="${path }/do/developer/redirect/sysFunction-list">功能管理</a></li>
							<li><a class="J_menuItem"
								href="${path }/do/developer/redirect/sysBtn-list">按钮管理</a></li>
						</ul></li>
				</ul>
			</div>
		</nav>
		...
		<div id="page-wrapper" class="gray-bg dashbard-1">
			...
			<div class="row content-tabs">
				...
				<a href="${path }/do/common/loginOut"
					class="roll-nav roll-right J_tabExit"><i
					class="fa fa fa-sign-out"></i> 退出</a>
			</div>
			<div class="row J_mainContent" id="content-main">
				<iframe class="J_iframe" name="iframe0" width="100%" height="100%"
					src="${path}/do/developer/redirect/welcome" frameborder="0" data-id="index_v1.html"
					seamless></iframe>
			</div>
			<div class="footer">
